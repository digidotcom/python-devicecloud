# -*- coding: utf-8 -*-
#
# python-devicecloud documentation build configuration file, created by
# sphinx-quickstart on Thu Jul  3 10:03:27 2014.
#
...
release = devicecloud.__version__
...
htmlhelp_basename = 'python-deviceclouddoc'
...
man_pages = [
    ('index', 'python-devicecloud', u'python-devicecloud Documentation',
     [u'Paul Osborne, Tom Manley, Stephen Stack'], 1)
]
...
autodoc_member_order = 'bysource'  # order in docs same as in source code
